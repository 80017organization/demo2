...
function init(config) {
  return function () {
      ...
      res.format({
        ...
        'text/html': function textHtml() {
          ...
          if (typeof config.uiIndex === 'function') {
            ...
            if (req.query.url) {
              res.sendFile(_path2.default.join(modulesRootPath, 'node_modules/swagger-ui/dist/index.html'));
            } else {
    ...
    app.providers.push(function (path, service) {
      ...
      var version = config.versionPrefix ? path.match(config.versionPrefix) : null;
